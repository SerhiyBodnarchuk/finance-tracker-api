...
<!-- SPECKIT START -->
**Current feature**: `001-domain-entities-dtos` ([spec.md](specs/001-domain-entities-dtos/spec.md), [plan.md](specs/001-domain-entities-dtos/plan.md))

For technologies in use, project structure, shell commands, and Phase 0/1 design decisions, read [specs/001-domain-entities-dtos/plan.md](specs/001-domain-entities-dtos/plan.md) first. Supporting artifacts: [research.md](specs/001-domain-entities-dtos/research.md), [data-model.md](specs/001-domain-entities-dtos/data-model.md), [contracts/](specs/001-domain-entities-dtos/contracts/), [quickstart.md](specs/001-domain-entities-dtos/quickstart.md).

> The plan's Constitution Check passes against [.specify/memory/constitution.md](.specify/memory/constitution.md) **v2.0.1** (ratified 2026-05-18, last amended 2026-05-21). The six historical drifts vs. v1.0.0 (DTO placement in Business; typed `ReportRequest` envelope; summary `ReportResult` shape; `int` ids; multi-category transactions; xUnit v3 / no FluentAssertions) were all ratified in the v2.0.0 amendment; v2.0.1 is wording cleanup. `/speckit-tasks` is unblocked.
<!-- SPECKIT END -->
